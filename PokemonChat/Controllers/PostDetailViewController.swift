...
class PostDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        usernameLabel.attributedText = Utils.getUsernameString(post["username"] as! String)
...
extension PostDetailViewController: DZNEmptyDataSetSource {
    ...
    func titleForEmptyDataSet(scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        return NSAttributedString(string: "Looks like there aren’t any comments yet.", attributes: attributes)
    }
    ...
    func buttonTitleForEmptyDataSet(scrollView: UIScrollView!, forState state: UIControlState) -> NSAttributedString! {
        ...
        return NSAttributedString(string: "POST A COMMENT", attributes: attributes)
    }
    
}

extension PostDetailViewController: DZNEmptyDataSetDelegate {
